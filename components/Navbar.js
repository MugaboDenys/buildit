    ...
    return ( 
        <div className="flex justify-between mb-10 px-32 py-10">
            <div className="flex items-center gap-x-3">
                <div className="w-12 h-12 rounded-full bg-primaryColor shadow-primaryColor shadow-2xl "></div>
            ...
            <div>
                <Link href={'/'} className="px-6 py-2 bg-primaryColor text-white text-xs font-bold rounded-md">Need a project?</Link>
            </div>
        </div>
     );
}
